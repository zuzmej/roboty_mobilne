...
## @brief Class right_hand contains right hand algorithm 
#
...
class right_hand(algorithm):
    ...
    ## @brief Right hand algorithm - finds the way to the center of the maze by turning right if it is possible.
    #
