...
## @brief Class graphics_engine contains drawing GUI application for mazes and algorithms visualisation.
#  
...
class graphics_engine(data):
    ...
    ## @brief Constructor -- creating raw layout which means push buttons and geometry
    #
    def __init__(self):
        self.window = tk.Tk()
    ...
    ## @brief Method to count the length of path that algorithm generated.
    #
    ...
    ## @brief Method to open window of selection to choose algorithm
    #  
    ...
    ## @brief Method to open window of selection to choose maze
    #
    ...
    ## @brief Method to close the selection windows after choosing algorithm or maze. It generates drawing chosen mazes.
    #
    ...
    ## @brief Method to draw chosen maze.
    #
    ...
    ## @brief Method to draw path generated by algorithm on a given maze.
    #
    def draw_path(self):
